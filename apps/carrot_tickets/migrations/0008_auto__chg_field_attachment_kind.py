...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Attachment.kind'
        db.alter_column('carrot_tickets_attachment', 'kind', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Attachment.kind'
        db.alter_column('carrot_tickets_attachment', 'kind', self.gf('django.db.models.fields.CharField')(max_length=10))
