...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('carrot_tickets_ticketattachment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('kind', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('ticket', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'attachments', to=orm['carrot_tickets.Ticket'])),
        ))
        db.send_create_signal('carrot_tickets', ['TicketAttachment'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('carrot_tickets_ticketattachment')
