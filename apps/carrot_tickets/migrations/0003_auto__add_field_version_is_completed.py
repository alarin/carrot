...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Version.is_completed'
        db.add_column('carrot_tickets_version', 'is_completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Version.is_completed'
        db.delete_column('carrot_tickets_version', 'is_completed')
