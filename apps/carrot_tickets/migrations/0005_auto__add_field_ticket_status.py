...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('carrot_tickets_ticket', 'status',
                      self.gf('django.db.models.fields.CharField')(default=u'open', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ticket.status'
        db.delete_column('carrot_tickets_ticket', 'status')
