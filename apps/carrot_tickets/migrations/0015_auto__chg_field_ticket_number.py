...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ticket.number'
        db.alter_column('carrot_tickets_ticket', 'number', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'Ticket.number'
        db.alter_column('carrot_tickets_ticket', 'number', self.gf('django.db.models.fields.CharField')(max_length=20))
