...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Attachment.kind'
        db.add_column('carrot_tickets_attachment', 'kind',
                      self.gf('django.db.models.fields.CharField')(default=u'file', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Attachment.kind'
        db.delete_column('carrot_tickets_attachment', 'kind')
    ...
    models = {
        ...
        'carrot_tickets.attachment': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'kind': ('django.db.models.fields.CharField', [], {'default': "u'file'", 'max_length': '10'}),
